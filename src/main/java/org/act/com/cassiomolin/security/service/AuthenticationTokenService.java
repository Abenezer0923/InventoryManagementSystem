package org.act.com.cassiomolin.security.service;
...
public class AuthenticationTokenService {
     ...
     * @return
     */
    public int issueToken(String username, Set<Authority> authorities) {
     ...
     * @return
     */
    public int refreshToken(AuthenticationTokenDetails currentTokenDetails) {
