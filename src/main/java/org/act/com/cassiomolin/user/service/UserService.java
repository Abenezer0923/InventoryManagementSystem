package org.act.com.cassiomolin.user.service;
...
// }
    ...
    public User findByUsernameOrEmail(String identifier) {
        ...
        List<User> users = em.createQuery("SELECT u FROM User1 u WHERE u.username = :identifier", User.class)
    ...
    public User findByUserPersonId(Long userPersonId) {
        List<User> users = em.createQuery("SELECT u FROM User1 u WHERE u.person =:identifier", User.class)
    ...
    public List<User> findAll() {
        return em.createQuery("SELECT u FROM User1 u", User.class).getResultList();
    }
